...
import random
import math
sys.path.append(r'/workspace/code/segmentation/Kaggle')
from Datahandling.Datasets import TisquantDatasetNew,ArtificialNucleiDataset,ArtificialNucleiDatasetNotConverted,MergedDataset,SegmentSample
...
ROOT_DIR = r"/workspace/code/segmentation/Mask_RCNN"#os.getcwd()
...
elif UNETSettings().network_info["dataset"] == 'segmentSample':
    dataset_test= SegmentSample()
else:
...
#print(dataset_test.image_path)
#print(dataset_test.mask_path)
...
model.load_weights(r"/workspace/code/segmentation/Mask_RCNN/logs/maskrcnn_artificialandnaturalnuclei_dataset_scaled_10000_200020181218T0315/mask_rcnn_maskrcnn_artificialandnaturalnuclei_dataset_scaled_10000_2000_epoch.h5", by_name=True)
...
for image_id in tqdm(dataset_test.image_ids):
    ...
    APs.append(AP)
    res.append(utils.compute_final_mask(r['masks']))
