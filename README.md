...
DeepFLEX: Deep learning-based single-cell analysis pipeline for FLuorescence multiplEX imaging via MELC (Multi-Epitope Ligand Cartography [1]).  
...
-feature extraction (morphological features, fluorescence intensity features) 
